...
// Ciclo de folga contínuo entre meses: conta os dias a partir de 01/08/2026
const CICLO = 6;
function cycleDay(mesKey, dayIdx) {
  const [y, m] = mesKey.split('-').map(Number);
  const n = Math.round((Date.UTC(y, m - 1, dayIdx + 1) - Date.UTC(2026, 7, 1)) / 86400000);
